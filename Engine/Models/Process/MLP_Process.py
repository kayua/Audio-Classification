...
class MLPProcess(ClassBalancer, WindowGenerator, BaseProcess, Metrics):
    """
    ...
    def train(self) -> tuple:
        ...
        for train_indexes, validation_indexes in instance_k_fold.split(features_train_validation,
            ...
            features_train, features_validation =\
                (features_train_validation[train_indexes], features_train_validation[validation_indexes])

            labels_train, labels_validation =\
                (labels_train_validation[train_indexes], labels_train_validation[validation_indexes])
