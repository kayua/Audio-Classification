...
class DenseModel(MetricsCalculator):
    ...
    def __init__(self, arguments):
        ...
        self.window_size_factor = arguments._raw_feature_window_size_factor
        self.decibel_scale_factor = arguments._patcher_spectrogram_decibel_scale_factor
        self.hop_length = arguments._patcher_spectrogram_hop_length
        self.intermediary_layer_activation = arguments.intermediary_layer_activation
        self.overlap = arguments._patcher_spectrogram_overlap
        self.window_size = arguments._patcher_spectrogram_hop_length * arguments._raw_feature_window_size_factor
        self.sample_rate = arguments._patcher_spectrogram_sample_rate
        self.file_extension = arguments._raw_feature_file_extension
