...
class MobileNetV3Process(ClassBalancer, WindowGenerator, BaseProcess, Metrics):
    ...
    def __init__(self, arguments):
        ...
        self.hop_length = arguments.mobilenetv3_hop_length
        self.decibel_scale_factor = arguments.mobilenetv3_decibel_scale_factor
        self.window_size_fft = arguments.mobilenetv3_window_size
        self.window_size_factor = arguments.mobilenetv3_window_size_factor
        self.window_size = arguments.mobilenetv3_hop_length * (self.window_size_factor - 1)
        self.input_shape = arguments.mobilenetv3_input_dimension
        self.overlap = arguments.mobilenetv3_overlap
        ...
        self.number_filters_spectrogram = arguments.mobilenetv3_number_filters_spectrogram
