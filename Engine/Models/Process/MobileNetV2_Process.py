...
class MobileNetV2Process(ClassBalancer, WindowGenerator, BaseProcess, Metrics):
    ...
    def __init__(self, arguments):
        ...
        self.hop_length = arguments.mobilenetv2_hop_length
        self.decibel_scale_factor = arguments.mobilenetv2_decibel_scale_factor
        self.window_size_fft = arguments.mobilenetv2_window_size
        self.window_size_factor = arguments.mobilenetv2_window_size_factor
        self.window_size = arguments.mobilenetv2_hop_length * (self.window_size_factor - 1)
        self.input_shape = arguments.mobilenetv2_input_dimension
        self.overlap = arguments.mobilenetv2_overlap
        ...
        self.number_filters_spectrogram = arguments.mobilenetv2_number_filters_spectrogram
