...
class AudioSpectrogramViewer:
    """
    A class to visualize the spectrogram of a WAV audio file using librosa.
    """
    ...
    def plot_spectrogram(self):
        """
        Plot the spectrogram of the audio file with optional parameters.
        """
        ...
        # Display spectrogram, limiting to fmax Hz
