...
class EvaluationModels:
    ...
    def plot_confusion_matrices(confusion_matrix_list, file_name_path, fig_size=(5, 5), cmap='Blues',
        ...
        """
        Plots confusion matrices for a list of models and saves them as images.
        ...
        fig_size : tuple, optional
            Size of the figure.
        cmap : str, optional
            Color map for the confusion matrix.
        annot_font_size : int, optional
            Font size for the annotations inside the matrix.
        ...
        for index, confusion_matrix_dictionary in enumerate(confusion_matrix_list):
            try:
                ...
                class_names = confusion_matrix_dictionary["class_names"]
